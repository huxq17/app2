...
import com.aiqing.im.R;
import com.aiqing.im.contact.ContactHelper;
import com.aiqing.im.contact.activity.UserProfileActivity;
import com.aiqing.im.session.action.FileAction;
import com.aiqing.im.session.action.GuessAction;
import com.aiqing.im.session.action.TipAction;
import com.aiqing.im.session.activity.MessageHistoryActivity;
import com.aiqing.im.session.activity.MessageInfoActivity;
import com.aiqing.im.session.extension.CustomAttachParser;
import com.aiqing.im.session.extension.CustomAttachment;
import com.aiqing.im.session.extension.GuessAttachment;
import com.aiqing.im.session.extension.SnapChatAttachment;
import com.aiqing.im.session.extension.StickerAttachment;
import com.aiqing.im.session.search.SearchMessageActivity;
import com.aiqing.im.session.viewholder.MsgViewHolderDefCustom;
import com.aiqing.im.session.viewholder.MsgViewHolderFile;
import com.aiqing.im.session.viewholder.MsgViewHolderGuess;
import com.aiqing.im.session.viewholder.MsgViewHolderSnapChat;
import com.aiqing.im.session.viewholder.MsgViewHolderSticker;
import com.aiqing.im.session.viewholder.MsgViewHolderTip;
