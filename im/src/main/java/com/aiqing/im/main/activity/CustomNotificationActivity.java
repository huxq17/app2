package com.aiqing.im.main.activity;
...
import com.aiqing.im.main.helper.CustomNotificationCache;
import com.aiqing.im.main.viewholder.CustomNotificationViewHolder;
...
public class CustomNotificationActivity extends UI implements TAdapterDelegate {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (item.getItemId() == R.id.send_custom_notification_to_team) {
