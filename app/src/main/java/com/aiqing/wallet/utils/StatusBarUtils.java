...
public class StatusBarUtils {
    private static final Object TAG_MARGIN_ADDED = "TAG_MARGIN_ADDED";
    private static final Object TAG_FAKE_STATUS_BAR_VIEW = "TAG_FAKE_STATUS_BAR_VIEW";
    ...
    public static void setWindowStatusBarColor(Activity activity, int colorResId) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            ...
            //添加一个View来作为状态栏的填充
            addFakeStatusBarView(activity, colorResId, statusBarHeight);
            //设置子控件到状态栏的间距
